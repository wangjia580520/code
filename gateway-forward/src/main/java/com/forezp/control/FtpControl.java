...
public class FtpControl {
    private static final Logger log = LoggerFactory.getLogger(FtpControl.class);
    private static String path = "/";
    private static String host = "192.168.29.58";
    private static int port = 21;
    private static String username = "ajia_ftp";
...
//            ftpClient.enterLocalPassiveMode();//开启被动模式，否则文件上传不成功，也不报错
    ...
    public static void main(String[] args) throws IOException {
        ...
        dowFile(ftpClient, "/home/ajia_ftp/", "aa.txt", "D:\\ftptest\\");
        uploadFile(ftpClient, "/home/ajia_ftp/", "1.txt", "D:\\123.txt");
